	...
	return (
		<footer className="bg-gray-900 text-white p-8 w-full">
			<div className="container mx-auto flex flex-wrap justify-between mt-3">
					...
					<div className="text-zinc-400">
						<p>
							...
							>
								...
								<div className="p-1">jayprabha@gmail.com</div>
							</Link>
						</p>
						<p>
							<Link to="tel:+91 9270326629" className="flex items-center">
								<MdAddCall />
								<div className="p-1">+91 9270326629</div>
							</Link>
						</p>
						<p>
							Address:{" "}
				...
				<div className="flex-shrink-0 w-full sm:w-1/2 md:w-1/4 lg:w-1/5 justify-items-center mt-4 sm:mt-0">
				...
				<div className="flex-shrink-0 w-full sm:w-1/2 md:w-1/4 lg:w-1/5 mt-4 sm:mt-0 justify-center">
					<h3 className="text-lg font-bold mb-2">Connect with Us</h3>
					<ul className="text-zinc-400 ">
						<li className=" items-center">
							<Link
								to="https://www.facebook.com/TechSolutions"
								target="_blank"
							...
							>
								...
								<div className="p-1">Facebook</div>
							</Link>
						</li>
						<li className="flex items-center">
							<Link
								to="https://www.instagram.com/jayprabha.holiday.home/"
								target="_blank"
								rel="noopener noreferrer"
					...
					<ul className="list-none text-zinc-400">
						<li className="flex items-center">
							...
							<div className="p-1">Whatsapp:</div>
						</li>
						<>
							<li>
								<Link to="https://wa.me/9270326629">+91 9270326629</Link>
							</li>
							<li>
								<Link to="https://wa.me/9764457976">+91 9764457976</Link>
							</li>
							<li>
								<Link to="https://wa.me/9370628695">+91 9370628695</Link>
							</li>
						</>
					</ul>
				</div>
